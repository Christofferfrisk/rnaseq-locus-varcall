...
docker run --rm -v "$DATA":/data --entrypoint samtools "$IMAGE" sort -o /data/sampleA.bam /data/sampleA.sam
docker run --rm -v "$DATA":/data --entrypoint samtools "$IMAGE" sort -o /data/sampleB.bam /data/sampleB.sam
